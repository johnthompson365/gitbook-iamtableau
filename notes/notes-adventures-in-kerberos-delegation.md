...
# Notes: Tableau and Presto with Kerberos sauce
...
{% embed url="https://github.com/rmbolger/Posh-ACME" caption="" %}
...
{% embed url="https://hub.docker.com/r/ahanaio/prestodb-sandbox" caption="" %}
