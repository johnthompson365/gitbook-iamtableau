...
There are instructions on the configuration in our [Help docs](https://help.tableau.com/current/online/en-us/scim_config_online.htm) for both Okta and OneLogin. The SCIM endpoint is secured with a token secret that is generated by TOL. We provide clear guidance around this:
